	...
	public Graph(Model model) {
		...
		useViewportGestures.addListener((obs, oldVal, newVal) -> {
			...
			if (newVal) {
				...
				//parent.addEventHandler(ScrollEvent.ANY, viewportGestures.getOnScrollEventHandler()); evita zoom
			} else {
				...
				//parent.removeEventHandler(ScrollEvent.ANY, viewportGestures.getOnScrollEventHandler()); evita zoom
			}
		});
		pannableCanvas.parentProperty().addListener((obs, oldVal, newVal) -> {
			if (oldVal != null) {
				...
				//oldVal.removeEventHandler(ScrollEvent.ANY, viewportGestures.getOnScrollEventHandler()); evita zoom
			}
			if (newVal != null) {
				...
				//newVal.addEventHandler(ScrollEvent.ANY, viewportGestures.getOnScrollEventHandler()); evita zoom
			}
		});
